...
class Client {
    ...
    private void importData() {
        ...
        int choice = getIntInput("Выберите формат: ");
        System.out.print("Введите путь к файлу: ");
        String filePath = scanner.next();
        boolean flag = false;
        DataImporter importer = switch (choice) {
            case 1 -> new CSVImporter(operationService.getFacade());
            case 2 -> new JSONImporter(operationService.getFacade());
            default -> {
    ...
    private void exportData() {
        ...
        ExportVisitor exporter = switch (choice) {
            case 1 -> new CSVExporter();
            case 2 -> new JSONExporter();
            default -> {
                System.out.println("Ошибка: Некорректный выбор.");
                yield null;
            }
    ...
    private void viewBankAccounts() {
        ...
        List<BankAccount> bankAccounts = AccountFacade.view();
    ...
    private void viewCategories() {
        ...
        List<Category> categories = CategoryFacade.view();
    ...
    private void addBankAccount() {
        ...
        Command command = new CreateBankAccountCommand(bankService, name, balance);
        command.execute();
    }
    ...
    private void editBankAccount() {
        ...
        Command command = new ChangeBankAccountCommand(bankService, accountId, newName, newBalance);
        command.execute();
    }
